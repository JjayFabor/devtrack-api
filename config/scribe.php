...
return [
    ...
    'description' => 'A personal productivity API for developers to manage tasks, log learning sessions, track progress on side projects, and store programming-related notes or bugs encountered—all in a centralized and versioned API.',

    // The base URL displayed in the docs.
    // If you're using `laravel` type, you can set this to a dynamic string, like '{{ config("app.tenant_url") }}' to get a dynamic base URL.
    'base_url' => env('APP_ENV') === 'production'
    ? 'https://devtrack-api-production.up.railway.app'
    ...
    'auth' => [
        ...
        'in' => \Knuckles\Scribe\Config\AuthIn::HEADER->value,
